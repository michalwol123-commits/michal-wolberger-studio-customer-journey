// Shared 13-stage configuration used across CRM and Portal
const STAGES = [
  ...
  { num: 4, key: 's4_status', label: 'סגירת פרויקט', shortLabel: 'סגירת פרויקט', icon: '📋', description: 'מעבר רשמי מפוטנציאל ללקוח פעיל והתחלת העבודה' },
  { num: 5, key: 's5_status', label: 'שאלון מפורט', shortLabel: 'שאלון מפורט', icon: '📝', description: 'איסוף מידע מעמיק לקראת תחילת התכנון' },
  { num: 6, key: 's6_status', label: 'פגישת תכנית + גאנט/תקציב', shortLabel: 'תכנית + גאנט', icon: '📐', description: 'הפיכת הדרישות לתכנית עבודה מסודרת עם לוחות זמנים ותקציב' },
  { num: 7, key: 's7_status', label: 'תכניות עבודה', shortLabel: 'תכניות עבודה', icon: '⚡', description: 'חשמל, אינסטלציה, תאורה ומיזוג — הכנה לביצוע' },
  ...
  { num: 10, key: 's10_status', label: 'תמחור קבלנים ובחירת ספקים', shortLabel: 'תמחור קבלנים', icon: '⚖️', description: 'קבלת הצעות מחיר, השוואה חכמה ובחירת אנשי מקצוע' },
